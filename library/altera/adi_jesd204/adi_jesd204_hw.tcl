...
proc jesd204_compose {} {
  ...
  if {[string equal $device_family "Arria 10"]} {
    ...
    set_instance_parameter_value link_pll {set_primary_use} {Core}
    set_instance_parameter_value link_pll {set_prot_mode} {Basic}
    set_instance_parameter_value link_pll {message_level} {warning}
    ...
    set_instance_parameter_value link_pll {rcfg_multi_enable} {0}
  ...
  add_connection link_reset.in_reset axi_xcvr.if_up_rst
